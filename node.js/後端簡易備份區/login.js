...
//   const validation = await schema.validate(req.body);
  ...
  const sql = "INSERT INTO `members`" +
      "(`account`, `password`, `email`, `avatar`, `mobile`, `address`, `birthday`, `nickname`, `cumulative_consumption`,`gender`,`verification_code`,`created_at`)" +
      " VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,NOW())";
  ...
  try {
      [result] = await db.query(sql, [
        ...
        req.body.birthday,
        req.body.nickname,
        req.body.cumulative_consumption,
        req.body.gender,
